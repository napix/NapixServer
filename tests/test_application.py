...
from napixd.loader import Loader, Load, ManagerImportError
...
class TestNapixBottleBuilder( unittest.TestCase):
    ...
    def test_make_services(self):
        ...
        with mock.patch( 'napixd.application.Service', spec=Service) as pService:
            ...
            self.bottle.make_services( load.managers)
        ...
        s1.setup_bottle.assert_called_once_with( self.bottle)
        s2.setup_bottle.assert_called_once_with( self.bottle)
...
class TestReload( unittest.TestCase):
    ...
    def setUp(self):
        ...
        load.managers = []
        self.ms = mock.patch.object( self.bottle, 'make_services', side_effect=self.bottle.make_services).start()
